...
var EndlessScene = new Phaser.Class({
  ...
  skipLevelWithBooster: function() {
    ...
    // === PATCH п.4: считаем уровни для достижений и статистики ===
    ...
    // === PATCH п.2: инкремент глобального totalLevels для разблокировки дуэлей ===
    EndlessMode.recordLevelCompleted(this.levelNumber);
